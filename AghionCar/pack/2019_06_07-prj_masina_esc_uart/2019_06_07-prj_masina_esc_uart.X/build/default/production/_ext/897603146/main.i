# 1 "D:/root/scoala/teste_n_5/2019_06_07-prj_masina_esc_uart/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "D:/root/scoala/teste_n_5/2019_06_07-prj_masina_esc_uart/main.c" 2
...
# 2 "D:/root/scoala/teste_n_5/2019_06_07-prj_masina_esc_uart/main.c" 2
...
unsigned char posMS = 1, speed1 = 200, receive, direction = 0, mode = 0, status = 2;
...
void __attribute__((picinterrupt("low_priority"))) myLowIsr(void)
{
    ...
    if (PIR1bits.RCIF == 1)
    {
        if(spi_delay > 100) {spi_cnt=0; rec_uart[0] = 0; rec_uart[1] = 0;}
